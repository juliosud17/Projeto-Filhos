...
const PT_MODULES_BENJAMIN = [
  ...
  },
  {
    ...
    habilidades:[
      ...
      "EF01LP03 — Comparar a própria escrita com a escrita convencional",
  ...
  },
  {
    ...
    habilidades:[
      ...
      "EF01LP17 — Produzir listas, agendas, avisos, convites e receitas",
    ...
    alem:["Escrita sempre dentro de um contexto real (lista, bilhete, parlenda), nunca uma palavra solta descontextualizada — o campo de texto livre é validado contra a palavra que falta, não é redação aberta sem correção nenhuma"],
  ...
  },
  {
    ...
    habilidades:[
      "EF01LP15 — Agrupar palavras por significado semelhante e oposto",
      "EF01LP20 — Reconhecer o formato de diferentes gêneros textuais",
      "EF01LP22 — Produzir diagramas, entrevistas e curiosidades investigativas",
      "EF01LP24 — Reproduzir a formatação de textos investigativos",
    ],
...
const MATH_MODULES_BENJAMIN = [
  ...
  },
  {
    ...
    bimestre:"1º bimestre",
    habilidades:["EF01MA04 — Contar a quantidade de objetos de coleções até 100 unidades, utilizando diferentes estratégias de contagem"],
  ...
  },
  {
    ...
    bimestre:"1º bimestre",
    habilidades:[
      "EF01MA05 — Comparar números naturais de até duas ordens, indicando o maior ou o menor",
      "EF01MA09 — Organizar objetos familiares por um atributo (tamanho)",
  ...
  },
  {
    ...
    bimestre:"3º bimestre",
    habilidades:[
      "EF01MA11 — Descrever a localização de pessoas e de objetos no espaço, utilizando termos como à direita, à esquerda, em cima, embaixo, perto, longe",
      "EF01MA12 — Descrever a localização de pessoas e de objetos no espaço segundo um ponto de referência, e indicar as mudanças de direção que devem ser feitas num percurso",
    ],
    alem:["Onde Está? usa uma grade 3×3 fixa (nunca ambígua) e sobe de dificuldade controlando QUAIS posições entram no sorteio por nível — nível 1-2 só pergunta esquerda/direita ou cima/embaixo isolados, níveis 4-5 já incluem cantos (\"em cima, à direita\")", "Siga o Mapa evolui de trajeto de 1 passo (mesma linha ou coluna do alvo) nos níveis 1-3 pra trajeto de 2 passos (diagonal, precisa combinar duas direções em ordem) nos níveis 4-5 — sempre com o ponto de referência (o robôzinho) visível no mapa"],
  ...
  },
  {
    ...
    bimestre:"3º bimestre",
    habilidades:[
      "EF01MA13 — Relacionar figuras geométricas espaciais (cubo, bloco retangular, pirâmide, cone, cilindro, esfera) a objetos do mundo físico",
      "EF01MA14 — Identificar e nomear figuras planas (círculo, quadrado, retângulo e triângulo) em desenhos, em diferentes disposições",
    ],
  ...
  },
  {
    ...
    bimestre:"4º bimestre",
    habilidades:[
      "EF01MA16 — Relatar em ordem cronológica acontecimentos ou fatos vividos, utilizando expressões como antes, agora, depois",
      "EF01MA17 — Reconhecer e relacionar períodos do dia, dias da semana e meses do ano, utilizando calendário, quando necessário",
      "EF01MA18 — Produzir a escrita de uma data, considerando as partes que a compõem (dia, mês, ano)",
    ],
