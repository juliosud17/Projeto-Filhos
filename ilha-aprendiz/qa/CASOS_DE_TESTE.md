...
| `qa_test_mapa_portugues.js` | Ilha das Letras (`js/mapa-portugues.js`): 8 hotspots acessíveis, os 5 estados visuais, clique bloqueado/desbloqueado, Módulo 8 abre Projeto Leitor (não Atividades), `backToModulos()` ciente da trilha, Matemática inalterada |
