...
| `digite-a-palavra.mp3` | "Digite a palavra:" | ✅ (2026-08-19, gravado e confirmado em `app/assets/audio/Lia/comuns/`) — usada no nível 5 ("Digite a Palavra"), antes de tocar a pronúncia da palavra em si. |
